package com.java.two.http.manager;
...
import com.java.two.base.BaseSchedulerTransformer;
import com.java.two.bean.NeteastNewsDetail;
import com.java.two.bean.NeteastNewsSummary;
...
import com.java.two.bean.WeatherInfo;
import com.java.two.http.Api;
import com.java.two.http.HostType;
import com.java.two.http.service.NewsService;
import com.java.two.utils.NetUtil;
...
public class RetrofitManager {
    ...
    public Observable<JsonNode> searchTsinghuaNewsObservable(int pageNo, int pageSize, String keywords) {
        return mNewsService.searchTsinghuaNews(pageNo, pageSize, keywords.replaceAll(" ", "%20")).compose(new BaseSchedulerTransformer<JsonNode>());
    }
    /**
